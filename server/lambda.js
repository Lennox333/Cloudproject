    ...
    try {
        ...
        for (const record of event.Records) {
            ...
            for (const resolution of resolutions) {
                ...
                console.log(`✓ Enqueued transcode job: ${videoId} @ ${resolution.name} - MessageId: ${sqsResult.MessageId}`);
            }
            ...
            console.log(`✓ Enqueued thumbnail job: ${videoId} - MessageId: ${thumbnailResult.MessageId}`);
